...
<div class="animated swing">
	...
	<div class="row text-center">
        ...
        <img src="tick.gif"/>
        <h3>Dear <?php echo $nam; ?></h3>
        <p style="font-size:20px;color:#5C5C5C;">Thank you for booking a seat in our restaurant. We have sent you an email with your booking details.</p>
