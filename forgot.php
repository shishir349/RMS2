 ...
 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <a class="nav-item nav-link active btn btn-block btn-success hey3" href="homepage.php">Home</a>
      <a class="nav-item nav-link active btn btn-block btn-danger hey2" style="text-align: left" href="login2.php">Login</a>
      	  <a class="nav-item nav-link active btn btn-block btn-dark hey2" style="text-align: left" href="reg3.php">Signup</a>
       	  </div>
  </div>
</nav>
<br>
...
<div class="container">
		...
		<form action="forgot.php" style="border:1px solid #ccc" method="post">
    <hr>
   ...
   <label for="psw"><b>Password(old)</b></label>
    <input type="password" placeholder="Enter Password" name="psw" required>
   
  <label for="psw"><b>Password(New)</b></label>
    ...
    <div class="clearfix">
      ...
      <input type="submit" class="signupbtn" name="s1" value="Reset Password" />
    </div>
  </div>
</form>
</div>
