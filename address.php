...
<body background="imgmenubg2.jpg">
...
<!-- Form Name -->
<center><h1 class="abc">Set Address and Time</h1></center>
...
<div class="form-group">
  ...
  <center><label class="abc"><h2>Timing</h2>
...
<?php
	if(!empty($_POST['s1']))
	{
		session_start();
	$use=$_SESSION['uid'];
		$z="delete from menu_new where userid='$use'";
		$con=mysqli_connect("127.0.0.1","root","","demo"); 
		if($con)
		{
			mysqli_query($con,$z);
...
<center><a href="homepage.php"><button id="button2id" name="button2id" class="btn btn-danger btn-g">Cancel</button></a>
</div>
</body>
</html>